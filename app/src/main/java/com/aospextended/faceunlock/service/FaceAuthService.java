...
public class FaceAuthService extends Service {
    private static final String ALARM_FAIL_TIMEOUT_LOCKOUT = "com.aospextended.faceunlock.ACTION_LOCKOUT_RESET";
    private static final String ALARM_TIMEOUT_FREEZED = "com.aospextended.faceunlock.freezedtimeout";
